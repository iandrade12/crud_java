...
import br.com.classes.DocumentoCnpj;
import br.com.classes.DocumentoCpf;
import br.com.classes.Funcionario;
import br.com.dal.FuncionariosDAO;
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					FileWriter  writer =  new 
							FileWriter
		("C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Data\\db_cadastro\\tbfuncionarios.ibd", true); 
		...
		btnGerarLista.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					FileReader  reader = 
 new FileReader("C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Data\\db_cadastro\\tbfuncionarios.ibd"); 
